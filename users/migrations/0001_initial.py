    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telephone', models.CharField(blank=True, max_length=20, null=True, unique=True, verbose_name='Телефон')),
            ...
            options={
                ...
                'permissions': (('set_user_deactivate', 'Can deactivate user'), ('view_all_user', 'Can view all user')),
            },
            managers=[
